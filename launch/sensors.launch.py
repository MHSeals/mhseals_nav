...
def create_relays(context):
    ...
    return [
        Node(
            package='topic_tools',
            executable='relay',
            arguments=[f'/{camera_name}/zed_node/rgb/color/rect/image/compressed', f'/{camera_name}_camera/rgb/image'],
            output='screen'
        ),
        Node(
            package='topic_tools',
        ...
        Node(
            package='topic_tools',
            executable='relay',
            arguments=[f'/{camera_name}/zed_node/rgb/color/rect/image/camera_info', f'/{camera_name}_camera/camera_info'],
            output='screen'
        ),
        Node(
            package='topic_tools',
